    ...
    <Wrapper>
      <ProjectList>
          ...
          {todolistClicked & open ? (
            <Details>
              ...
              <Info>
                ...
                delete a task after the to do list has loaded. Also, I learned
                how to implement error handling in case something would go wrong
                with the fetch request.*
                <br />* Because of the data being fetched from localhost,
                Netlify displays 'failed to fetch'. Therefore, I uploaded a
                previous version without error handling and edit option. Both
                versions are on GitHub.
              </Info>
              <Website
          ...
          {movieFilterClicked & open ? (
            <Details>
              ...
              <Info>
                ...
                feedback I was a complimented for chosing clear method names,
                and received the tip to use arrow functions. In this project, we
                had to present a movie list and provide five different filter
                options in the form of radio buttons. When clicking on a film
                poster, the user had to be lead to the corresponding page on
                imdb.com. The focus lay on functionality and javascript, styling
                was a bonus requirement.
              </Info>
              <Website
        ...
        <Project>
          ...
          {colourToggleDesignClicked & open ? (
            <Details>
              {/* <Close onClick={activeToggle}>X</Close> */}
              <Stack>HTML, CSS, JavaScript</Stack>
              <Summary>A project of my own.</Summary>
              <Info>
                Inspired by the Colour Toggle assignment, I wanted to create a
                fun version of it, using a bright picture in the background.
                This time, the chosen colour shines through from behind the
                image of a painted wall, giving the website a red, orange,
                purple or greenish hue. It was quite a adventure to create a
                playful design and position all elements correctly.
              </Info>
              <Website
          ...
          {colourToggleClicked & open ? (
            <Details>
              ...
              <Info>
                ...
                how to reduce repetition in javascript and css code. The
                challenge was to create a clickable hamburger with a toggle
                function, making a colour menu visible on first click, and
                letting it dissapear on the next. Also, the menu had to become
                visible when hovering over the hamburger. Additional
                interactivity comprised change of background colour matching the
                colour selected in the menu.
              </Info>
              <Website
        ...
        <Project>
          ...
          {socialMediaButtonsClicked & open ? (
            <Details>
              {/* <Close onClick={activeToggle}>X</Close> */}
              <Stack>HTML, CSS, JavaScript</Stack>
              <Summary>
          ...
          {portfolioGridClicked & open ? (
            <Details>
              ...
              <Info>
                ...
                and make the grid responsive with 1, 2 and 3 columns
                respectively for mobile, tablet and desktop.
              </Info>
              <Website
        ...
        <Project>
          ...
          {firstWebsiteClicked & open ? (
            <Details>
              {/* <Close onClick={activeToggle}>X</Close> */}
              <Stack>HTML, CSS</Stack>
              <Summary>First Winc Academy front-end assignment.</Summary>
              <Info>
                I learned how to make a website using a mobile-first approach
                and semantic HTML, and received useful feedback on how to apply
                the right indentation and to neatly organise all files. The
                website had to cover a clearly outlined topic and to contain
                multiple pages, images and a form. We had to demonstrate
                understanding of the box-model and use flexbox or grid for
                positioning.
              </Info>
              <Website
